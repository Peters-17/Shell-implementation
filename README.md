...
This project can be performed in a group of 2. You have a total of THREE slip days that can be used throughout the semester for late projects; you can use some of those days for this project, but we hope you can save them!
1. Overview
...
2.3) Aliases (Not mandatory to implement this feature. Skip, if you are not interested.)
...
Note: No tests will be provided for testing your aliasing feature implementation.
...
You will have to implement some sort of data structure for your aliases. We recommend using a LinkedList because it allows for easy addition and removal. For your future benefit, it may be worth implementing a generic LinkedList. If you plan to implement aliasing, you may run some test cases in public-tester folder.
